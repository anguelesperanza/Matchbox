...
void main()
{
    ...
    vec4 sampled_ = vec4_ZERO;
    vec4 result_ = vec4_ZERO;
    sampled_ = texture_sample(data_._res_.texture_a_, data_._res_.s_, uv_);
    result_ = vec4(data_._res_.color_.r, data_._res_.color_.g, data_._res_.color_.b, (data_._res_.color_.a * sampled_.a));
